  ...
  return (
    <div className="privacy-policy">
      ...
      <p>
        ...
        when you visit our website. By accessing or using our Website, you
      ...
      <ul>
        ...
        <li>In connection with a business transfer (e.g., merger, sale)</li>
      </ul>
      ...
      <p>
        ...
        <br />
        <strong>Email:</strong> info@ictconco.org
      </p>
    </div>
  );
};
